...
const BMRCalculator = () => {
  ...
  const calculateBMR = () => {
    ...
    if (w > 0 && h > 0 && a > 0) {
      ...
      const bmrResult = parseFloat(bmrValue.toFixed(0));
      const tdeeResult = parseFloat(calories.toFixed(0));
      
      setBMR(bmrResult);
      setDailyCalories(tdeeResult);
      
      updateAIInsight(
        { age: a, gender, height: h, weight: w, activityLevel: activity },
        { 
          bmr: bmrResult,
          tdee: tdeeResult,
          weightLossCalories: tdeeResult - 500,
          weightGainCalories: tdeeResult + 500
        }
      );
    }
  };
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      onClick={() => printCalculation({
                        ...
                        results: [
                          { label: "BMR", value: `${bmr} cal/day` },
                          { label: "TDEE", value: `${dailyCalories} cal/day` }
                        ],
                        formula: "BMR = 10W + 6.25H - 5A + 5 (men) or -161 (women)"
                      })}
                    >
